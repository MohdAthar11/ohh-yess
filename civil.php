...
<body>
    ...
    <div class="isflex">
        ...
        <div class="isright">
            <h1 style="padding:10px 0px;">Civil Engineering</h1>
            <table>
    ...
    <table>
                ...
                <tbody>   
                    <tr>
                        <td>Dr. VENUGOPAL K</td>
                        <td>BE, M.E, Ph.D</td>
                        <td>Professor & HOD</td>
                    </tr>
                    <tr>
                        <td>Mrs. DHANYA A V</td>
                        <td>M Sc, PGDIM(Ph.D)</td>
                        <td>Assistant Professor</td>
                    </tr>
                    <tr>
                        <td>Mrs. TESSA T EDATHIL </td>
                        <td>BE,M.Tech</td>
                        <td> Assistant Professor</td>
                    </tr>
                    <tr>
