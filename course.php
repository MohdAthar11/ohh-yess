...
<body>
    ...
    <div class="course">
        <div class="courseleft">
            ...
            <ul class="courseul">
                <li class="courseli"><a href="is.php">INFORMATION SCIENCE</a></li>
                <li class="courseli"><a href="cs.php">COMPUTER SCIENCE</a></li>
                <li class="courseli"><a href="ec.php">ELECTRONICS</a></li>
                <li class="courseli"><a href="mech.php">MECHANICAL</a></li>
                <li class="courseli"><a href="civil.php">CIVIL</a></li>
            </ul>
        </div>
        <div class="courseright">
            ...
            <ul class="courseul">
                <li class="courseli"><a href="admission.php">INFORMATION SCIENCE</a></li>
                <li class="courseli"><a href="admission.php">COMPUTER SCIENCE</a></li>
                <li class="courseli"><a href="admission.php">ELECTRONICS</a></li>
                <li class="courseli"><a href="admission.php">MECHANICAL</a></li>
                <li class="courseli"><a href="admission.php">CIVIL</a></li>
            </ul>
        </div>
        <div class="courseleft">
                ...
                <ul class="courseul">
                    <li class="courseli"><a href="admission.php"> CONSTRUCTION MANAGEMENT</a></li>
                    <li class="courseli"><a href="admission.php">BUSINESS MANAGEMENT</a></li>
                    <li class="courseli"><a href="admission.php">BRAND MANAGEMENT</a></li>
                    <li class="courseli"><a href="admission.php">BANKING</a></li>
                    <li class="courseli"><a href="admission.php">AVIATION </a></li>
                </ul>
            </div>
    </div>
