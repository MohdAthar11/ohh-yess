...
<head>
    ...
    <link rel="stylesheet" media="screen" href="is.css">    
...
<body>
    ...
    <img src="image/campus.jpg" alt="college image" height="450px" width="100%">
    <div class="isflex">
        <div class="isleft">
            <img src="image/logo.png" alt="IS HOD" width="250px" height="300px">
            <p>Dr.SUNDEEP KUMAR K <br>BE,M.Tech,M.E,Ph.D(CSE) <br>Professor and HOD</p>
        </div>
        <div class="isright">
            <h1 style="padding:10px 0px;">Computer Science</h1>
            <table>
                <caption> <h2 style="padding:10px 0px;">Syllabus </h2></caption>
                <thead>
                    <tr>
                        <th><h3> Year </h3></th>
                        <th> <h3>Subject </h3></th>
                        <th><h3>Syllabus</h3></th>
                    </tr>
                </thead> 
                <tbody>   
                    <tr>
                        <td>1</td>
                        <td>Mathematics-I, Mathematics-II, Physics, Chemistry, C language</td>
                        <td><a href="http://vtu.ac.in/b-e-scheme-syllabus/">View complete syllabus</a></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td> Algorithm, DataStructure, Software Engineering, DCN, C++</td>
                        <td><a href="http://vtu.ac.in/b-e-scheme-syllabus/">View complete syllabus</a></td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>Netwoks, Database, Automata Theroy, Compiler, Java</td>
                        <td><a href="http://vtu.ac.in/b-e-scheme-syllabus/">View complete syllabus</a></td>
                    </tr>
                    <tr>
                        <td>4</td>
                        <td>Python, Machine Learning, Web Technologies, ACA, Cloud Computing</td>
                        <td><a href="http://vtu.ac.in/b-e-scheme-syllabus/">View complete syllabus</a></td>
                    </tr>
                </tbody>
    </table>
    <table>
                <caption> <h2 style="padding:10px 0px;">Faculty </h2></caption>
                <thead>
                    <tr>
                        <th><h3> Name </h3></th>
                ...
                <tbody>   
                    <tr>
                        <td>Dr.SUNDEEP KUMAR K</td>
                        <td>BE,M.Tech(IT),M.E(CSE),Ph.D(CSE)</td>
                    ...
                    <tr>
                        <td>Dr.B.Loganayagi</td>
                        <td>BE,M.E,Ph.D</td>
                        <td>Professor</td>
                    </tr>
                    <tr>
                        <td>Ms.SHRUTHI A P </td>
                        <td>BE, M.Tech</td>
                        <td>Assistant Professor</td>
                    </tr>
                    <tr>
                        <td>Mr.SUKHESH H A</td>
                        <td>BE, M.Tech</td>
                        <td>Assistant Professor</td>
                    </tr>
                    <tr>
