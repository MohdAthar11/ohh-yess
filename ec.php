...
<body>
    ...
    <div class="isflex">
        <div class="isleft">
            ...
            <p>Mrs. GAYATHRI N <br>BE, M.Tech <br>Professor and HOD</p>
        </div>
        <div class="isright">
            <h1 style="padding:10px 0px;">Electronics and Communications</h1>
            <table>
                ...
                <tbody>   
                    <tr>
                        ...
                        <td><a href="#">View complete syllabus</a></td>
                    </tr>
                    <tr>
                        <td>2</td>
    ...
    <table>
                ...
                <tbody>   
                    <tr>
                        <td>Dr.ANANTHA PADMANABHAN S</td>
                        <td>BE, M.Tech, Ph.D</td>
                        <td> Professor HOD</td>
                    </tr>
                    <tr>
                        <td>Dr.SELVA KUMAR R </td>
                        <td>BE, M.Tech, Ph.D</td>
                        <td> Professor</td>
                    </tr>
                    <tr>
                        <td>Dr.KRISHNA KUMAR K </td>
                        <td>BE, M.Tech, Ph.D</td>
                        <td>Professor</td>
                    </tr>
                    <tr>
                        <td>Mr.PRADEEP KUMAR N S </td>
                        <td>BE, M.Tech</td>
